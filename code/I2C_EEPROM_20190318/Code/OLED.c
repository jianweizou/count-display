...
extern int I2C_SoftWare_Master_Write_One_Byte(int DeviceAddr,char cmd, char value);
#define OLED_WR_Byte(val,cmd_data)	I2C_SoftWare_Master_Write_One_Byte(0x3C,cmd_data,val)
